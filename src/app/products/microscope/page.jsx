            ...
            <main className="product-page-container">
                ...
                <section className="product-display">
                    ...
                    <div className="product-info-header">
                        <h2 id="product-name">Microscope & Image Analyzer - Product Details</h2>
                        <p>
                            Detailed information about Microscope & Image Analyzer. This section will contain specific technical details, features, and descriptions for the Microscope & Image Analyzer product range.
                    ...
                    <div className="product-image-gallery">
                        ...
                        <div className="product-main-image-container">
                            <img src={mainImage} alt="Microscope & Image Analyzer Main View" id="main-product-image" />
                        </div>
                    </div>
                    <div className="product-details-content">
                        ...
                        <p className="product-description-text">
                            Comprehensive description of the Microscope & Image Analyzer. It is designed for high precision and durability in industrial applications.
                        </p>
